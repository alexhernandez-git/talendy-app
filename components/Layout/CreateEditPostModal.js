                    ...
                    <div>
                      ...
                      <div className="mt-2 relative">
                        <button
                          ...
                          className="text-gray-500 dark:text-gray-100 bg-white dark:bg-gray-700 relative w-full border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                          aria-haspopup="listbox"
                          aria-expanded="true"
                          aria-labelledby="listbox-label"
                        >
                        ...
                        <div ref={communitiesRef}>
                          {communitiesOpen && (
                            ...
                            >
                              ...
                              <li
                                className="text-gray-500 dark:text-gray-100 cursor-pointer select-none relative py-2 pl-3 pr-9"
                                id="listbox-option-0"
                                role="option"
                              >
                                <span className="font-normal block truncate">
