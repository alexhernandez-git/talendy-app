...
export default function Home() {
  ...
  const [collaborateRoomImg, setCollaborateRoomImg] = useState(
    "/static/images/screenshot-white-clean-cropped.png"
  );
  useEffect(() => {
    if (authReducer.theme === "dark") {
      setCollaborateRoomImg("/static/images/screenshot-dark-clean-cropped.png");
    } else {
      setCollaborateRoomImg(
        "/static/images/screenshot-white-clean-cropped.png"
      );
    }
  }, [authReducer.theme]);
    ...
    >
      <main className="mt-10">
        ...
        <div className="relative">
          <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gray-100  dark:bg-gray-900" />
          <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-pink-600 to-orange-600 mix-blend-multiply opacity-90" />
              </div>
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                  <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:flex sm:justify-center">
                    {/* <span
