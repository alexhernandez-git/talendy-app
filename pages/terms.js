      ...
      <div className="relative py-16 bg-white  dark:bg-gray-800 overflow-hidden">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 prose prose-cyan prose-lg text-gray-500 dark:text-gray-200 mx-auto">
            <p>Welcome to talendy.com!</p>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of Talendy's Website, located at https://talendy.com.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use talendy.com if you do not agree
            ...
            <h2>
              <strong className="text-gray-900 dark:text-white">Cookies</strong>
            </h2>
            <p>
              We employ the use of cookies. By accessing talendy.com, you agreed
              to use cookies in agreement with the Talendy's Privacy Policy.{" "}
            </p>
            <p>
            ...
            <h2>
              <strong className="text-gray-900 dark:text-white">License</strong>
            </h2>
            <p>
              Unless otherwise stated, Talendy and/or its licensors own the
              intellectual property rights for all material on talendy.com. All
              intellectual property rights are reserved. You may access this
              from talendy.com for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul>
              <li>Republish material from talendy.com</li>
              <li>Sell, rent or sub-license material from talendy.com</li>
              <li>Reproduce, duplicate or copy material from talendy.com</li>
              <li>Redistribute content from talendy.com</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Talendy does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of Talendy,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, Talendy
            ...
            <p>
              Talendy reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant Talendy a non-exclusive license to use,
            ...
            <p>
              ...
              Talendy; and (d) the link is in the context of general resource
              information.
            </p>
            <p>
            ...
            <p>
              ...
              by sending an e-mail to Talendy. Please include your name, your
            ...
            <p>
              No use of Talendy's logo or other artwork will be allowed for
              linking absent a trademark license agreement.
            </p>
            <h2>
              <strong className="text-gray-900 dark:text-white">iFrames</strong>
            </h2>
            <p>
