...
export default function lastNotificationsReducer(state = initialState, action) {
  switch (action.type) {
    // case HYDRATE:
    //   // Attention! This will overwrite client state! Real apps should use proper reconciliation.
    //   return { ...state, ...action.payload.lastNotificationsReducer };
    case FETCH_LAST_NOTIFICATIONS:
      return {
        ...state,
        is_loading: true,
      };
    case FETCH_LAST_NOTIFICATIONS_SUCCESS:
      return {
        ...state,
        is_loading: false,
    ...
    case FETCH_LAST_NOTIFICATIONS_FAIL:
      return {
        ...state,
        is_loading: false,
